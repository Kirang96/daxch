export const GUIDE_OVERVIEW = [
  "Daxch helps you trade with more context, not more noise. Before you buy, use **Research** to run AI analysis on a stock — fundamentals, technicals, news, and sentiment — so you can decide with evidence instead of guesswork.",
  "Once you own a position, **monitoring agents** watch the stock and what moves around it on a schedule you choose: earnings, headlines, price action, and macro shifts. Daxch surfaces that ongoing picture and suggests next steps — **you stay in control and approve every trade**.",
] as const;
...
export const GUIDE_SECTIONS = [
  {
    ...
    paragraphs: [
      "An **agent monitors one stock** you chose. You set a planned limit price and quantity — that plan feeds the AI and is **not synced from your Demat**.",
      "When you create an agent, Daxch places a **LIMIT buy** at your chosen price. **Monitoring and AI unit usage begin only after your order fills** on the exchange. If placement fails, use **Retry entry** on the agent page; while awaiting fill, the agent stays paused.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "Your entry price and quantity on the agent page are **inputs to the AI thesis**. Exchange trades below are **real orders sent to your broker after you approve** a suggestion.",
      "P/L and positions appear only **after orders fill**. On schedule, the agent researches the stock and may suggest buy more, sell, or hold — **nothing is sent until you approve**. Use **Square off** to exit part or all at market without waiting for AI.",
    ],
  },
  {
    id: "broker-units",
    ...
    paragraphs: [
      "Daxch connects to your broker via **OAuth** with read and trade scopes you approve. We **never store your broker password**; revoke access anytime from your broker or by disconnecting in Daxch.",
      "Each analysis run and monitoring check consumes **AI Units** from your monthly plan. **Starter** uses GPT-4o Mini only; **Pro** and **Ultra** can choose other models in Settings.",
    ],
  },
] as const;
